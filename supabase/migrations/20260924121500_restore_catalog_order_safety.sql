-- Hotfix: mantém o checkout público somente para visitantes e garante
-- que o cancelamento devolva o estoque sem ser bloqueado pelo trigger
-- de proteção de produtos com pedidos ativos.
...
begin
  ...
  -- Primeiro libera a reserva. O trigger de proteção de estoque
  -- permite a devolução somente depois que o pedido deixa de estar ativo.
